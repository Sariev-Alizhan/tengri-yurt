...
CREATE TABLE orders (
  ...
  shipping_method TEXT CHECK (shipping_method IN ('air', 'sea')) DEFAULT NULL,
  estimated_logistics_days_min INTEGER DEFAULT NULL,
  estimated_logistics_days_max INTEGER DEFAULT NULL,
  created_at TIMESTAMPTZ DEFAULT NOW(),
