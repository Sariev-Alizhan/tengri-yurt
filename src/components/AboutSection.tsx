...
export function AboutSection({
  ...
  return (
    <>
      ...
      >
        <div className="max-w-6xl mx-auto" style={revealStyle(visible)}>
          <h2 className="font-garamond mb-6" style={{ fontSize: 'clamp(36px, 7vw, 80px)', color: 'rgba(255,255,255,0.95)' }}>
            {aboutTitle}
          </h2>
          <p className="font-inter font-light max-w-full mb-10 leading-relaxed" style={{ fontSize: 'clamp(14px, 2vw, 16px)', color: 'rgba(255,255,255,0.7)' }}>
            {aboutText}
          </p>
          <button
            type="button"
